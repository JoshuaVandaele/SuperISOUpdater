...
class Ubuntu(GenericHTTPMirror):
    ...
    def __init__(self, arch: str, edition: str) -> None:
        ...
        checksum_url: str = (
            f"http://cdimages.ubuntu.com/xubuntu/releases/{version}/release/SHA256SUMS"
        )

        super().__init__(
            uri=f"http://cdimages.ubuntu.com/xubuntu/releases/{version}/release/",
