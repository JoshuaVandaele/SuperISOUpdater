...
class MirrorService(GenericHTTPMirror):
    ...
    def __init__(self, arch: str, edition: str) -> None:
        ...
        checksum_url: str = f"https://www.mirrorservice.org/sites/cdimage.ubuntu.com/cdimage/kubuntu/releases/{version}/release/SHA256SUMS"

        super().__init__(
            uri=f"https://www.mirrorservice.org/sites/cdimage.ubuntu.com/cdimage/kubuntu/releases/{version}/release/",
    ...
    def _determine_latest_version(self) -> Version:
        r = self.session.get(
            "https://www.mirrorservice.org/sites/cdimage.ubuntu.com/cdimage/kubuntu/releases/",
        )
        r.raise_for_status()
