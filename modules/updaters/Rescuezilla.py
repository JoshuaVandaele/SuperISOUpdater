...
from modules.updaters.util_update_checker import github_get_latest_version
...
class Rescuezilla(GenericUpdater):
    ...
    def __init__(self, folder_path: str, edition: str) -> None:
        ...
        self.latest_tag, self.download_links = github_get_latest_version(
    ...
    def check_integrity(self) -> bool:
        sha256_url = self.download_links["SHA256SUM"]
    ...
    def _get_latest_version(self) -> list[str]:
        return self._str_to_version(self.latest_tag)
